...
% % 1. MCMC results
mcmcRes = readtable('16_rate/mcmc_result.csv');
...
numRandom = 500;
log_thres = log2(16); % varying threshold
...
save('16_rate/prctile_log_titre.mat','prctile_log_titre');
save('16_rate/prctile_seroprotect.mat','prctile_seroprotect');
...
load('16_rate/prctile_log_titre.mat','prctile_log_titre');
load('16_rate/prctile_seroprotect.mat','prctile_seroprotect');
